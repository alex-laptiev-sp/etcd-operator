...
First create a backup of your current cluster before starting the upgrade process. See the [backup service guide](https://github.com/alex-laptiev-sp/etcd-operator/blob/v0.6.1/doc/user/backup_service.md) on how to create a backup.

In the case of an upgrade failure you can restore your cluster to the previous state from the previous backup. See the [spec examples](https://github.com/alex-laptiev-sp/etcd-operator/blob/v0.6.1/doc/user/spec_examples.md) on how to do that.
...
The v0.6.0 release removes [operator S3 flag](https://github.com/alex-laptiev-sp/etcd-operator/blob/v0.5.1/doc/user/backup_config.md#operator-level-configuration).
...
- Create a backup of your current cluster data. See the following guides on how to enable and create backups:
    - [backup config guide](https://github.com/alex-laptiev-sp/etcd-operator/blob/master/doc/user/backup_config.md) to enable backups fro your cluster
    - [backup service guide](https://github.com/alex-laptiev-sp/etcd-operator/blob/master/doc/user/backup_service.md) to create a backup
...
- Replace the existing RBAC rules for the etcd-operator by editing or recreating the `ClusterRole` with the [new rules for CRD](https://github.com/alex-laptiev-sp/etcd-operator/blob/master/doc/user/rbac.md#create-clusterrole).
